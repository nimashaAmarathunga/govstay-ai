...
const INITIAL_BUNGALOWS = [
  {
    ...
    description: "A secluded setting with colonial architecture. Perfect for a weekend getaway in the cool climate.",
    rooms: 5,
    capacity: 2
  },
  {
    ...
    description: "Experience the history of Galle Fort. Located right within the historic walls.",
    rooms: 3,
    capacity: 3
  },
  {
    ...
    description: "Overlooking the beautiful Kandy Lake, providing a serene environment.",
    rooms: 4,
    capacity: 2
  },
  {
    ...
    description: "Located at the edge of Yala National Park. Includes guided tours.",
    rooms: 8,
    capacity: 4
  }
];
...
export default function BrowsePage() {
  ...
  const [selectedBungalow, setSelectedBungalow] = useState<typeof INITIAL_BUNGALOWS[0] | null>(null);
  const [bookingStatus, setBookingStatus] = useState<"idle" | "booking" | "success">("idle");

  const filteredBungalows = INITIAL_BUNGALOWS.filter(b => 
